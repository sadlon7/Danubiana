...
<body>
	...
	<div class="container containerWithSpecialWidth">
		<div class="row">
			...
			<div class="transportIcons">
				...
				<a href="doprava-autobus.php">		<img class="active" src="assets/images/logos/bus.png" alt="Bus Image">			</a>
	...
	<img class="imgMainImage" src="assets/images/bus.jpg" alt="carousel">
