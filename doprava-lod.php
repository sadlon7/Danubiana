...
<!-- 			<div class="subMenuBig">
			...
			<div class="transportIcons">
				...
				<a href="doprava-lod.php">			<img class="active" src="assets/images/logos/ship.png" alt="Ship Image">		</a>
	...
	<img class="imgMainImage" src="assets/images/ship.jpg" alt="carousel">
