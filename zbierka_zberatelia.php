<?php 
include ("head.php"); 
includeHead("Zbierka zberatelia | Danubiana");
?>
	...
	<div class="container containerWithSpecialWidth">
		<div class="row">
			<div class="subMenuSmall">
				...
				<a href="zbierka_zberatelia.php"  class="active">Zbierka zberatelia</a>
			</div>

			<div class="subMenuBig">
				<a href="" class="active">ZBIERKA ZBERATELIA</a>
			</div>
		</div>
	</div>
