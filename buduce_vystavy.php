<?php 
include ("head.php"); 
includeHead("Budúce výstavy | Danubiana");
?>
...
<body>
	...
	<div class="container containerWithSpecialWidth">
		<div class="row">
				<div class="subMenuSmall">
					...
					<a href="aktualne_vystavy.php">AKTUÁLNE VÝSTAVY</a>
					<a href="buduce_vystavy.php" class="active">BUDÚCE VÝSTAVY</a>
				</div>

				<div class="subMenuBig">
					<a href="" class="active">Budeme vystavovať</a>
				</div>
		</div>
	</div>
	...
	<div class="container containerWithSpecialWidth">
		<div class="row">
				...
				<h1>In lacinia, tellus vitae laoreet</h1>

				<p>
				Lorem ipsum dolor sit amet, consectetuer adipiscing elit. In lacinia, tellus vitae laoreet ultrices, lectus ligula dictum dui, eget condimentum velit dui vitae ante. Nulla nonummy augue nec pede. Pellentesque ut nulla. Donec at libero. Pellentesque at nisl ac nisi fermentum viverra. Praesent odio. Phasellus tincidunt diam ut ipsum. Donec eget est. Aenean et est a dui semper facilisis. Pellentesque placerat elit a nunc. Nullam tortor odio, rutrum quis, egestas ut, posuere sed, felis. Vestibulum placerat feugiat nisl. Suspendisse lacinia, odio non feugiat vestibulum, sem erat blandit metus, ac nonummy magna odio pharetra felis. Vivamus vehicula velit non metus faucibus auctor. Nam sed augue. Donec orci. Cras eget diam et dolor dapibus sollicitudin. In lacinia, tellus vitae laoreet ultrices, lectus ligula dictum dui, eget condimentum velit dui vitae ante. Nulla nonummy augue nec pede. Pellentesque ut nulla. Donec at libero. Pellentesque at nisl ac nisi fermentum viverra. Praesent odio. Phasellus tincidunt diam ut ipsum. Donec eget est.
				<br><br>
