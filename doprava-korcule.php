...
<!-- 			<div class="subMenuBig">
			...
			<div class="transportIcons">
				...
				<a href="doprava-peso.php">			<img src="assets/images/logos/walk.png" alt="Walk Image">		</a>
				<a href="doprava-moto.php">			<img src="assets/images/logos/moto.png" alt="Moto Image">		</a>
				<a href="doprava-korcule.php">		<img class="active" src="assets/images/logos/skate.png" alt="Skate Image">		</a>
	...
	<img class="imgMainImage" src="assets/images/skate.jpg" alt="carousel">
