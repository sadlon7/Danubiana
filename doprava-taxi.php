...
<!-- 			<div class="subMenuBig">
			...
			<div class="transportIcons">
				...
				<a href="doprava-taxi.php">			<img class="active" src="assets/images/logos/taxi.png" alt="Taxi Image">		</a>
			</div>
		</div>
	</div>

	<img class="imgMainImage" src="assets/images/taxi.jpg" alt="carousel">
