...
<!-- 			<div class="subMenuBig">
			...
			<div class="transportIcons">
				...
				<a href="doprava-bicykel.php">		<img class="active" src="assets/images/logos/bike.png" alt="Bike Image">		</a>
				<a href="doprava-taxi.php">			<img src="assets/images/logos/taxi.png" alt="Taxi Image">		</a>
			</div>
		</div>
	</div>

	<img class="imgMainImage" src="assets/images/bike.jpg" alt="carousel">
