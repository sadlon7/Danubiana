...
<!-- 			<div class="subMenuBig">
			...
			<div class="transportIcons">
				...
				<a href="doprava-moto.php">			<img class="active" src="assets/images/logos/moto.png" alt="Moto Image">		</a>
	...
	<img class="imgMainImage" src="assets/images/moto.jpg" alt="carousel">
