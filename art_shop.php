...
<body>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="art_shop.php">ARTSHOP</a></li>
	...
	<img class="imgMainImage" src="assets/images/artshop.jpg" alt="carousel">
	...
	generateSlides("assets/images/carousel-galery/artshop/");
	include ("footer.php"); 
